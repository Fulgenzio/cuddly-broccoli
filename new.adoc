...
La prima forma di magia, quella praticata originariamente da elfi e dragoni, è una forma di magia che consente all'individuo di attingere all'energia astrale 
